...
### [Database and Collection Creation](uk_food/NoSQL_setup.ipynb)

Create, and import the data into, the database. Followed by connecting to the MongoDB a Jupyter Notebook and PyMongo:

- Using the [establishments.json](uk_food/Resources/establishments.json) data file provided, use the 'mongoimport' function in a terminal to create a database named 'uk-food' and a collection 'establishments' to import the documents.
...
### [Update Documents and Field Datatypes](uk_food/NoSQL_setup.ipynb)
...
### [Exploratory Analysis](uk_food/NoSQL_analysis.ipynb)
...
With the database documents prepared, conduct some exploratory analysis on the database to provide some high level insights:
    ...
    I've also output the results for each DataFrame into a CSV format.

- Which establishments have a hygiene score equal to 20?
    - CSV Output - [hygiene](uk_food/csv_outputs/hygiene_df.csv)
- Which establishments in "London" have a 'RatingValue' greater than or equal to 4?
    - CSV Output - [london_rating](uk_food/csv_outputs/london_rating.csv)
- What are the top 5 establishments with a 'RatingValue' of 5, sorted by lowest hygiene score, nearest to the new restaurant added, "Penang Flavours"?
    - CSV Output - [near_penang](uk_food/csv_outputs/near_penang_df.csv)
- How many establishments in each Local Authority area have a hygiene score of 0? Sort the results from highest to lowest, and print out the top ten local authority areas.
    - CSV Output - [aggregate](uk_food/csv_outputs/aggregate_df.csv)
